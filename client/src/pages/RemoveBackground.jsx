        ...
        <div className="mt-6">
          ...
          <form onSubmit={onSubmitHandler} encType="multipart/form-data">
            <div className="space-y-4">
              <label className="block w-full h-12 px-4 bg-red-50 text-red-700 rounded-lg 
              ...
              <button
                ...
                className={`w-full h-12 flex justify-center items-center gap-2 
                  ...
                  ${!input || loading ? 'opacity-50' : 'hover:shadow-md'}`}
              >
                {loading ? (
        ...
        <div className="flex items-center justify-between">
          ...
          {content && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 bg-red-50 text-red-600 text-xs rounded-md hover:bg-red-100 transition-colors"
            >
